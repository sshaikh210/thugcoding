...
public class ApplicationSecurityAdapter extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/thug_code/assets/img/**").permitAll()
        .antMatchers("/images/**").permitAll()
        .antMatchers("/thug_code/assets/fonts/**").permitAll()
        .antMatchers("/thug_code/assets/css/**").permitAll()
        .antMatchers("/thug_code/assets/js/**").permitAll()
        .antMatchers("/thug_code/assets/lib/**").permitAll()
        .antMatchers("/thug_code/app/**").permitAll()
